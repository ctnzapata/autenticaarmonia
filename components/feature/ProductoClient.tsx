...
import { Star, MessageCircle, Sparkles, ChevronLeft } from 'lucide-react';
import { generateWhatsAppLink } from '@/lib/application/generateWhatsAppLink';
import { type Product, type ProductColor, type ProductSize, formatCOP } from '@/lib/domain/types';
...
export default function ProductoClient({ product, related }: Props) {
    ...
    const whatsappUrl = generateWhatsAppLink(product, {
        ...
        selectedColor, selectedSize, initials, specialNote,
    });
                            ...
                            <div style={{ display: 'flex', gap: '0.75rem', marginTop: '1rem' }}>
                                {product.images.map((img, i) => (
                                    <div key={i} style={{
                                        ...
                                        background: '#f1f5f9',
                                        overflow: 'hidden',
                                        border: i === 0 ? '2px solid var(--color-teal)' : '2px solid transparent',
                                        cursor: 'pointer',
                                    }}>
